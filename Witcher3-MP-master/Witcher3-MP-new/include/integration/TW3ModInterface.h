...
namespace TW3Integration
{
    ...
    struct SharedMemoryHeader
    {
        ...
        uint32_t readOffset;   // Current read position
        uint32_t writeOffset;  // Current write position
    };
    ...
    private:
        ...
        bool InitializeREDkitIntegration();
        std::string FindREDkitPath();
        bool LoadAssetFromPath(const std::string& path, std::vector<uint8_t>& data) const;
        ...
        bool m_initialized;
        bool m_modConnected;
        bool m_redkitInitialized;
        uint32_t m_tw3ProcessId;
